...
#    scp -r -i ~/.ssh/id_rsa ./*.json paperspace@"$ip_address":/home/paperspace/prog_synth/LibraryLearning
...
#    scp -r -i ~/.ssh/id_rsa ./cruxeval/evaluation/*.py abhinav@anton.j"$ip_address".rice.edu:/home/abhinav/prog_synth/Liblearn/cruxeval/evaluation/
    ...
    #scp -r -i ~/.ssh/id_rsa ./*.json abhinav@anton.j"$ip_address".rice.edu:/home/abhinav/prog_synth/Liblearn/
