...
class BenchmarkArguments:
    ...
    load_my_custom_model: bool = field(
        default=False,
        metadata={
            "help": "Load my custom model for benchmarking"
        },
    )
    
    custom_models: Dict[str, torch.nn.Module] = dict_field(
        default=[],
        metadata={
            "help": (
                "Custom models to be provided for benchmarking. Provide as key-value pairs, e.g. "
                "`{custom_model1_name: CustomModel1}`"
            )
        },
    )
